...
typedef struct MontPointD_params{
	__u32 prec;
	__u32 f_sel;
	__u32 sec_calc;
	__u32 n[128];
...
typedef struct MontPointAdd_params{
	__u32 prec;
	__u32 f_sel;
	__u32 sec_calc;
	__u32 n[128];
...
#define		IOCTL_MWMAC_MONTPOINTD	_IOWR(IOCTL_BASE, 17, MontPointD_params_t)
#define		IOCTL_MWMAC_MONTPOINTADD _IOWR(IOCTL_BASE, 18, MontPointAdd_params_t)